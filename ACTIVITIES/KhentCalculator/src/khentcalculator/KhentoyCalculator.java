...
package khentcalculator;


public class KhentoyCalculator extends javax.swing.JFrame {

    
   public KhentoyCalculator() {
    initComponents();
  }
 ...
 public void enable()
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        ...
        int pogi = jTextField1.getText().length();
        int nahida = jTextField1.getText().length() - 1;
        String genshin;
        
        if(pogi > 0)
        {
            StringBuilder likod = new StringBuilder(jTextField1.getText());
            likod.deleteCharAt(nahida);
            genshin = likod.toString();
            jTextField1.setText(genshin);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KhentoyCalculator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KhentoyCalculator().setVisible(true);
            }
        });
    }
